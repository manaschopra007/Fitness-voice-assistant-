#this model takes input in english speech and 
#outputs english speech and text and converted hindi text 
...
def speak(audio):
    engine.say(audio)
    print(audio)
    translated = EngtoHindi(audio)
    print(translated.convert)
    engine.runAndWait()
...
#
 ...
 #           codePath = r"C:\\Users\\Innoveight\\AppData\\Local\\Programs\\Opera\\launcher.exe"
 #           os.startfile(codePath)
            ...
            speak("I have been created by Manas.")
            ...
            speak("Thanks to Manas. Furthermore It's a secret")

 #       elif 'power point presentation' in query:
 #           speak("opening Power Point presentation")
 #           power = r"C:\\Users\\Innoveight\\Desktop\\Minor Project\\Presentation\\Voice Assistant.pptx"
 #           os.startfile(power)
 ...
 #           os.startfile(appli)
            ...
            try:
                jsonObj = urlopen(
                    '''https://newsapi.org/v1/ articles?source=the-times-of-india&sortBy=top&apiKey=\\531a64ee3326465e9de01d0b84e4d968\\''')
        ...
        # NPPR9-FWDCX-D2C8J-H872K-2YT43
            ...
            wishMe()
            speak("Jarvis  point o in your service Mister")
            speak(assname)
